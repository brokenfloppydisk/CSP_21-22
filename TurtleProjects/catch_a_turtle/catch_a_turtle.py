...
def manage_leaderboard():
    ...
    if (len(leader_scores_list) < 5 or score > leader_scores_list[4]):
        ...
        lb.draw_leaderboard(leader_names_list, leader_scores_list, True, spot, score, [border_drawer, score_writer, counter, spot])

    else:
        lb.draw_leaderboard(leader_names_list, leader_scores_list, False, spot, score, [border_drawer, score_writer, counter, spot])
