...
print(f"The maximum anomaly is: {max_anomaly} which occured in {max_year}")
print(f"The minimum anomaly is: {min_anomaly} which occured in {min_year}")
print(f"The average anomaly is: {avg_anomaly}")
